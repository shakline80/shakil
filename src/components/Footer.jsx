            ...
            <div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div className="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
                    ...
                    <FooterWidget
                        ...
                        usefulLink={[
                            { name: "iOs", href: "/" },
                            { name: "Android", href: "/about" },
                            { name: "Mac", href: "/services" },
                            { name: "Windows", href: "/contact" },
                        ]}
                    />
                ...
                <div className="text-center">
                    <a href="#"
                        ...
                        <img src={FooterLogo} className="h-6 mr-3 sm:h-9" alt="Learn with Sumit Logo" />Learn with Sumit </a>
